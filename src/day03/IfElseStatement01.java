...
public class IfElseStatement01 {
	...
	public static void main(String[] args) {
		/*kullanýcýdan 4 iþlemden birini seçmesini isteyeceðiz
		 * 2 sayý girsin.
		 * sonucu yazdýr.
		 */
		Scanner scan = new Scanner(System.in);
		System.out.println("bir iþlem giriniz");
		...
		}else if(islem.toUpperCase().equals("ÇARPMA")) {
			System.out.println("ÇARPMA SONUCU= "+num1*num2);
		}if(islem.toUpperCase().equals("ÇIKARMA")) {
			System.out.println("ÇIKARMA SONUCU= " + (num1-num2));
		}else if(islem.toUpperCase().equals("BÖLME")) {
			System.out.println("BÖLME SONUCU= "+num1/num2);
		}else {
			System.out.println("LÜTFEN BÝR ÝÞLEM GÝRÝNÝZ...");
		}scan.close();
