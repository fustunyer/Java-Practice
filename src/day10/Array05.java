...
public class Array05 {
	...
	public static void main(String[] args) {
		// Kullanicidan 30.01.2000 formayinda tarih alacagiz ve
		//bu tarihi yaziya ceviren java koduunu yaziniz otuzocakikibin
		...
		System.out.println("gun.ay.yil  formatinda Bir tarih giriniz");
		...
		int yilyuzler=new Integer(tarih.substring(8,9));
		...
		System.out.println("Girilen taihin yazi ile yazilmasi " +onlar[on]+birler[bir]+" "+aylar[ay]+" "+ binler[yilbinler]+yuzler[yilyuzler]+onlar[yilonlar]+birler[yilbirler]);
